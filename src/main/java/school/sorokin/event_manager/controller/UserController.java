...
public class UserController {
    ...
    @PostMapping
    public ResponseEntity<UserShowDto> createRegistration(@RequestBody @Valid SingUpRequest singUpRequest) {
        log.info("Get request for sign-un: login = {}", singUpRequest.getLogin());
        UserShowDto user = userService.createForRegistration(singUpRequest);
    ...
    public ResponseEntity<UserShowDto> getUserById(@PathVariable Long id) {
        ...
        UserShowDto userShowDto = userService.getUserShowDtoById(id);
